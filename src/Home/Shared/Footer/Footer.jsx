...
<footer className="w-full bg-slate-50 overflow-x-hidden">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
                <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                    ...
                    <img className=" w-[150px] h-[62px]  md:w-[150px] lg:w-[150px] lg:h-[62px]  " src="https://i.ibb.co/RGRfYG1D/eventnest-high-resolution-logo-transparent-1.png" alt="" />
                    </Link>
                    <p className="py-4 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left ">ACME Industries Ltd. <br/>Providing reliable tech since 1992</p>
                    <Link to="/contact">
                ...
                <div className="lg:mx-auto text-center ">
                    ...
                    <ul className="text-sm  transition-all duration-500">
                        <li className="mb-6"><Link to="/"  className="text-gray-600 hover:text-gray-900 hover:font-medium ">Home</Link></li>
                        <li className="mb-6"><Link to="/about"  className=" text-gray-600 hover:text-gray-900 hover:font-medium ">About Us</Link></li>
                        <li><Link to="/events"  className=" text-gray-600 hover:text-gray-900 hover:font-medium ">Events</Link></li>
                    </ul>
                </div>
                ...
                <div className="lg:mx-auto text-center ">
                    ...
                    <ul className="text-sm  transition-all duration-500">
                        <li className="mb-6"><a href="javascript:;"  className="text-gray-600 hover:text-gray-900 hover:font-medium ">Customer Support</a></li>
                        <li className="mb-6"><a href="javascript:;"  className=" text-gray-600 hover:text-gray-900 hover:font-medium ">Terms & Conditions</a></li>
                        <li ><a href="javascript:;"  className=" text-gray-600 hover:text-gray-900 hover:font-medium ">Privacy Policy</a></li>
                    </ul>
                </div>
                ...
                <div className="lg:mx-auto text-center ">
                    ...
                    <a   className="mx-auto flex items-center justify-center gap-2 border border-indigo-600 rounded-full py-3 px-6 w-fit lg:mx-10  text-sm text-indigo-600 font-semibold transition-all duration-500 hover:bg-indigo-50 ">Subscribe<svg width="15" height="12" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="py-7 border-t border-gray-200">
                <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                    <span className="text-sm text-gray-500 ">©Copyright 2025, All rights reserved.</span>
